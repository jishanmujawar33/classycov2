    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h1 className="heading-bold text-4xl sm:text-6xl md:text-[7.5vw] lg:text-[7vw] xl:text-[110px] leading-none mb-8 text-white tracking-tighter">
            The <br className="sm:hidden" /> New <br /> <span className="whitespace-nowrap">Standard<span className="text-street-accent absolute select-none">.</span></span>
          </h1>
